...
if(isset($_POST['Change_Admin_Password']))
	...
	else
	{
		...
		$query = mysql_query("select * from Admin where Username='$Username'", $ServerConnection);
		$rows = mysql_num_rows($query);

		// Confirm new password
		if ($rows == 1)
		{
			mysql_query("UPDATE Admin SET Password='$New_Password' WHERE Username = '$Username'");
