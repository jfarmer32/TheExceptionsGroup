...
<html>
<header>
<title>User Inventory - VIMS</title>
...
<div class="title">
  ...
  <div class="contents">
    <div class="welcome">
      <h1>Valor Inventory Management System</h1>
      <h2>Change Attributes</h2>
    	<div>
    		<input name = "attributes" type = "text" placeholder="Attributes"> <br>
    		<input   name = "update_attributes" type = "submit" value = " Update Arributes " style = "margin-left: 0px;">
    	</div>
	</div>
	<div class = "welcome">	
    	...
    	echo "<input name = 'print' formaction='/~pklene/print_cadet_gear.php' type = 'submit' value = 'Print Table' style = 'margin-left: 0px;'>";
    	echo "<input name = 'filter' formaction='/~pklene/gear_filter.php' type = 'submit' value = 'Filter By Gear Type' style = 'margin-left: 2%;'>";
    	echo "<input name = 'view' formaction='/~pklene/user_discrepncey.php' type = 'submit' value = 'View Inventory Deficiencies' style = 'margin-left: 2%;'>";
		echo "</div>";
      ?>
    </div>
  </div>
